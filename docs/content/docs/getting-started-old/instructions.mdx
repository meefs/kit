...
**Content redistributed to:** The instruction creation walkthrough will move to [Recipes — Creating a Token](/recipes/creating-a-token), and program client patterns will move to [Guides — Using Program Plugins](/docs/guides/using-program-plugins).
