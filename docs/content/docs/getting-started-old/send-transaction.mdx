...
**Content redistributed to:** The [Getting Started](/docs/getting-started) one-pager will cover sending transactions briefly, and [Guides — Sending Transactions](/docs/guides/sending-transactions) will be the comprehensive reference.
...
const estimateAndSetComputeUnitLimit = null as unknown as ReturnType<
